      ...
      <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
        ...
        <Card className="p-5">
          ...
          <div className="space-y-3">
            {[
              { label: "Protein", consumed: d.macros_consumed?.protein_g ?? 0, target: d.macros_target?.protein_g ?? 0, color: "bg-blue-500" },
              { label: "Carbs", consumed: d.macros_consumed?.carbs_g ?? 0, target: d.macros_target?.carbs_g ?? 0, color: "bg-amber-500" },
              { label: "Fat", consumed: d.macros_consumed?.fat_g ?? 0, target: d.macros_target?.fat_g ?? 0, color: "bg-orange-500" },
